...
var module = angular.module('exampleApp', ['language-picker','ngSanitize']);
  module.controller('MainCtrl', function ($scope, $modal,$compile) {
   ...
   $scope.codeSamples = {
     ...
     typical: '<language-picker languages="codeSamples.supportedLangs" on-change="onLanguageChange(language)">\n  Language Picker\n</language-picker>',
     noFlags: '<language-picker languages="codeSamples.supportedLangs" on-change="onLanguageChange(language)"  flags="false">\n  Language Picker\n</language-picker>',
     customModal: '<language-picker languages="codeSamples.supportedLangs" on-change="onLanguageChange(language)"  flags="false">\n  Language Picker\n</language-picker>',
     attributes: '<language-picker languages="codeSamples.supportedLangs" on-change="onLanguageChange(language)" template="custom.tpl.html">\n   Choose language\n</language-picker>',
